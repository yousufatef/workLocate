                        ...
                        <SheetContent side="left">
                            <div className="flex flex-col gap-2 py-4 p-6">
                                <Link
                                    href="/"
                                    onClick={closeSheet}
                                    className="flex items-center gap-2 text-lg font-bold mb-10"
                                >
                                ...
                                <nav className="flex flex-col gap-3">
                                    <Link href="/" onClick={closeSheet} className="flex items-center gap-2 text-muted-foreground hover:text-foreground text-xl font-semibold mb-6">
                                        <Home className="h-8 w-8" />
                                        <span>Home</span>
                                    </Link>
                                    <Link href="/about" onClick={closeSheet} className="flex items-center gap-2 text-muted-foreground hover:text-foreground text-xl font-semibold mb-6">
                                        <Calendar className="h-8 w-8" />
                                        <span>About</span>
                                    </Link>
                                    {(user && user.publicMetadata && (user.publicMetadata.role === "admin" || user.publicMetadata.role === "owner")) ? (
                                        <Link href="/dashboard" onClick={closeSheet} className="flex items-center gap-2 text-muted-foreground hover:text-foreground text-xl font-semibold mb-6">
                                    ...
                                    <Link href="/contact" onClick={closeSheet} className="flex items-center gap-2 text-muted-foreground hover:text-foreground text-xl font-semibold mb-6">
